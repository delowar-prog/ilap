...
<div class="card mb-4">
    <div class="card-header py-3 bg-light d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?php echo e(route('admin.letter-templates.edit', $letterTemplate->id)); ?>" class="btn btn-primary btn-sm rounded-pill me-2">
    ...
    <div class="card-body p-4 bg-secondary bg-opacity-10 d-flex justify-content-center">
        ...
        <div class="bg-white shadow p-5 border" style="max-width: 800px; width: 100%; min-height: 900px; font-family: Arial, sans-serif; position: relative;">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($letterTemplate->subject): ?>
                <h5 class="text-center fw-bold text-dark text-uppercase mb-4" style="text-decoration: underline;">
                    <?php echo e($letterTemplate->subject); ?>
...
<?php echo $__env->make('layouts.backend_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iLap\resources\views\backend\letter_templates\preview.blade.php ENDPATH**/ ?>