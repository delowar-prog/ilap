        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <!-- Dashboard -->
                    <a class="nav-link" href="<?php echo e(route('student.dashboard')); ?>" role="button">
                        <div class="d-flex align-items-center">
                ...
                <?php endif; ?>
                <!-- ==================== Courses & Academic ==================== -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['course view', 'institute view'])): ?>
                <li class="nav-item">
...
<?php /**PATH C:\laragon\www\ilap\resources\views/backend/admin_component/navbar1_verticale.blade.php ENDPATH**/ ?>