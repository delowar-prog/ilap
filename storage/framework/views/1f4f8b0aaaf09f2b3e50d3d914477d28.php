...
<div class="card mb-4">
    <div class="card-header py-3 bg-light d-flex justify-content-between align-items-center">
        <h5 class="mb-0 text-primary fw-bold">
            <i class="fas fa-edit me-2"></i> Edit Invoice Template
        </h5>
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('admin.invoice-templates.update', $invoiceTemplate->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title', $invoiceTemplate->title)); ?>" required>
                        </div>
                        <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>" onchange="toggleCustomType(this.value)" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($types)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeOpt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <option value="<?php echo e($typeOpt); ?>" <?php echo e(old('type', $invoiceTemplate->type) == $typeOpt ? 'selected' : ''); ?>><?php echo e($typeOpt); ?></option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <option value="add_new" class="fw-bold text-primary">+ Add New Custom Type...</option>
                            </select>
                            <div id="custom_type_box" class="mt-2 d-none">
                                <input type="text" name="custom_type" id="custom_type_input" class="form-control border-primary" placeholder="Type new invoice type name..." value="<?php echo e(old('custom_type')); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="subject" class="form-control" value="<?php echo e(old('subject', $invoiceTemplate->subject)); ?>">
                    </div>

                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label class="form-label fw-semibold"><i class="fas fa-image me-1 text-info"></i> Invoice Header Image</label>
                            <input type="file" name="header_image" class="form-control" accept="image/*">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoiceTemplate->header_image): ?>
                                <div class="mt-2">
                                    <small class="text-success d-block mb-1"><i class="fas fa-check-circle"></i> Current Header:</small>
                                    <img src="<?php echo e(asset('storage/' . $invoiceTemplate->header_image)); ?>" alt="Header" class="img-thumbnail" style="max-height: 50px;">
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold"><i class="fas fa-image me-1 text-info"></i> Footer Image</label>
                            <input type="file" name="footer_image" class="form-control" accept="image/*">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoiceTemplate->footer_image): ?>
                                <div class="mt-2">
                                    <small class="text-success d-block mb-1"><i class="fas fa-check-circle"></i> Current Footer:</small>
                                    <img src="<?php echo e(asset('storage/' . $invoiceTemplate->footer_image)); ?>" alt="Footer" class="img-thumbnail" style="max-height: 50px;">
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Invoice Content Body <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>" rows="12" required><?php echo e(old('content_body', $invoiceTemplate->content_body)); ?></textarea>
                    </div>

                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="status" id="templateStatus" value="1" <?php echo e(old('status', $invoiceTemplate->status) ? 'checked' : ''); ?>>
                    ...
                    <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5 mt-3">
                        <i class="fas fa-save me-1"></i> Update Invoice Template
                    </button>
                </div>
...
<?php echo $__env->make('layouts.backend_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iLap\resources\views\backend\invoice_templates\edit.blade.php ENDPATH**/ ?>