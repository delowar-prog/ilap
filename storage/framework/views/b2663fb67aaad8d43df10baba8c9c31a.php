...
<script src="<?php echo e(asset('contents/backend/assets')); ?>/vendors/popper/popper.min.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/vendors/bootstrap/bootstrap.min.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/vendors/anchorjs/anchor.min.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/vendors/is/is.min.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/vendors/echarts/echarts.min.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/vendors/fontawesome/all.min.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/vendors/lodash/lodash.min.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/vendors/list.js/list.min.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/assets/js/theme.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/assets/js/custom.js"></script>
<script src="<?php echo e(asset('contents/backend/assets')); ?>/assets/js/fontawesome-iconpicker.min.js"></script>
...
<script>
  ...
  <?php /**PATH C:\laragon\www\iLap\resources\views\backend\admin_component\js\script.blade.php ENDPATH**/ ?>