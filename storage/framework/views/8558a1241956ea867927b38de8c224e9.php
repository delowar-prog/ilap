...
<div class="card">
    ...
    <form action="<?php echo e(route('institutes.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card-body">
            <div class="row g-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('eiin')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('registration_number')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('institute_type')); ?>" placeholder="e.g. University, College">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('established_year')); ?>" placeholder="e.g. 1998">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3876854453-0', $__key);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('postal_code')); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" name="institute_images[]" class="form-control <?php $__errorArgs = ['institute_images.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.backend_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iLap\resources\views\backend\institute\create.blade.php ENDPATH**/ ?>