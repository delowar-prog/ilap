<div class="card">
    <div class="card-header d-flex justify-content-between py-2">
        <h6 class="mb-0 fw-semibold text-uppercase d-flex align-items-center">
            <i class="fas <?php echo e($city && $city->exists ? 'fa-edit' : 'fa-plus'); ?> me-2"></i>
            <?php echo e($city && $city->exists ? 'Edit City: ' . $city->name : 'Create City'); ?>

        </h6>
        <a href="<?php echo e(route('cities.index')); ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select wire:model.live="country_id" class="form-select <?php $__errorArgs = ['country_id'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-6">
                    ...
                    <select wire:model.live="state_id" class="form-select <?php $__errorArgs = ['state_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" <?php echo e(!$country_id ? 'disabled' : ''); ?>>
                        <option value=""><?php echo e(!$country_id ? 'Select Country First' : 'Select State'); ?></option>
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter city name">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" wire:model="city_code" class="form-control <?php $__errorArgs = ['city_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter city code">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="card-footer text-end py-2">
            <button type="submit" class="btn btn-primary btn-sm">
                ...
                <?php echo e($city && $city->exists ? 'Update City' : 'Save City'); ?>

            </button>
        </div>
    </form>
</div>
<?php /**PATH C:\laragon\www\iLap\resources\views\livewire\geo\city-form.blade.php ENDPATH**/ ?>