...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('admin.invoice-templates.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g. Official Student Tuition Fee Invoice" value="<?php echo e(old('title')); ?>" required>
                        </div>
                        <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>" onchange="toggleCustomType(this.value)" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="subject" class="form-control" placeholder="e.g. INVOICE FOR ACADEMIC TUITION FEES" value="<?php echo e(old('subject')); ?>">
                    </div>
...
<?php echo $__env->make('layouts.backend_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iLap\resources\views\backend\invoice_templates\create.blade.php ENDPATH**/ ?>