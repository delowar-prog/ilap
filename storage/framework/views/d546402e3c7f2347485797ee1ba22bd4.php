...
<div class="card mb-3">
        ...
        <div class="row align-items-center">
            <div class="col">
                <h5 class="mb-0 text-primary fw-bold">
                    <i class="fas fa-file-invoice-dollar me-2"></i> Invoice Templates Engine
                </h5>
                <small class="text-muted">Create, edit and manage dynamic invoice templates for student generation</small>
            </div>
            <div class="col-auto">
                <a href="<?php echo e(route('admin.invoice-templates.create')); ?>" class="btn btn-primary btn-sm rounded-pill px-3">
    ...
    <div class="card-body">
        ...
        <form method="GET" action="<?php echo e(route('admin.invoice-templates.index')); ?>" class="row g-2 mb-4">
            <div class="col-md-5">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search') || request('type')): ?>
                    <a href="<?php echo e(route('admin.invoice-templates.index')); ?>" class="btn btn-outline-danger" title="Reset Filters"><i class="fas fa-redo"></i></a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </form>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="form-check form-switch d-inline-block m-0">
                                    <input class="form-check-input template-status-toggle" 
                                           ...
                                           data-url="<?php echo e(route('admin.invoice-templates.toggle', $template->id)); ?>"
                            ...
                            <td class="text-end">
                                <a href="<?php echo e(route('admin.invoice-templates.preview', $template->id)); ?>" class="btn btn-sm btn-info text-white me-1" title="Preview Dummy Output">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('admin.invoice-templates.edit', $template->id)); ?>" class="btn btn-sm btn-primary me-1" title="Edit Template">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="<?php echo e(route('admin.invoice-templates.destroy', $template->id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="btn btn-sm btn-danger delete-btn-confirm" data-text="You want to delete this invoice template!" title="Delete Template">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <tr>
                            <td colspan="7" class="text-center py-4 text-muted">
                                ...
                                No invoice templates found. Click <strong>Add New Template</strong> to create one.
                            </td>
                        </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </tbody>
...
<?php echo $__env->make('layouts.backend_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iLap\resources\views\backend\invoice_templates\index.blade.php ENDPATH**/ ?>