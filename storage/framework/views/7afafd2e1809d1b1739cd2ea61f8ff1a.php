<div>
    ...
    <input type="hidden" name="country" value="<?php echo e($selectedCountryName); ?>">
    <input type="hidden" name="city" value="<?php echo e($selectedCityName); ?>">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCountryIso2): ?>
                <div class="mt-1">
                    <span class="badge bg-info bg-opacity-10 text-info" style="font-size: 0.75rem;">ISO2: <?php echo e($selectedCountryIso2); ?></span>
                </div>
        ...
        <div class="col-md-4">
            ...
            <select wire:model.live="selectedState" class="form-select" 
                    <?php echo e(!$selectedCountry ? 'disabled' : ''); ?>>
                <option value="">
                    <?php echo e(!$selectedCountry ? 'Select Country First' : 'Select State'); ?>
        ...
        <div class="col-md-4">
            ...
            <select wire:model.live="selectedCity" class="form-select" 
                ...
                <option value="">
                    <?php echo e(!$selectedState ? 'Select State First' : 'Select City'); ?>
    ...
    <div class="mt-3 small text-muted">
        Selected: Country ID: <?php echo e($countryId ?? 'N/A'); ?>, 
        State ID: <?php echo e($stateId ?? 'N/A'); ?>, 
        City ID: <?php echo e($cityId ?? 'N/A'); ?>

    </div>
</div><?php /**PATH C:\laragon\www\ilap\resources\views/livewire/geo/location-selector.blade.php ENDPATH**/ ?>