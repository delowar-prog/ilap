...
unset($__errorArgs, $__bag); ?>" required>
                        <option value="1" <?php echo e(old('is_ilap_course', $course->is_ilap_course) == '1' ? 'selected' : ''); ?>>
                            🏠 iLAP Own Course
                        </option>
                        <option value="0" <?php echo e(old('is_ilap_course', $course->is_ilap_course) == '0' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('institute_country', $course->institute_country)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('institute_website', $course->institute_website)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                              rows="3"><?php echo e(old('description', $course->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-12">
                    <div id="course_modules_container">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->modules && $course->modules->count() > 0): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $course->modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="row g-2 mb-2 align-items-center module-row">
                                <input type="hidden" name="modules[<?php echo e($index); ?>][id]" value="<?php echo e($module->id); ?>">
                                <div class="col-md-2">
                                    <label class="form-label mb-0">Code</label>
                                    <input type="text" name="modules[<?php echo e($index); ?>][code]" class="form-control form-control-sm" placeholder="Module Code" value="<?php echo e($module->code); ?>">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label mb-0">Title</label>
                                    <input type="text" name="modules[<?php echo e($index); ?>][title]" class="form-control form-control-sm" placeholder="Module Title" value="<?php echo e($module->title); ?>">
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label mb-0">Credit</label>
                                    <input type="text" name="modules[<?php echo e($index); ?>][credit]" class="form-control form-control-sm" placeholder="Credit" value="<?php echo e($module->credit); ?>">
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label mb-0" title="Guided Learning Hours">GLH</label>
                                    <input type="text" name="modules[<?php echo e($index); ?>][glh]" class="form-control form-control-sm" placeholder="GLH" value="<?php echo e($module->glh); ?>">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label mb-0">Type</label><br>
                                    <div class="form-check form-check-inline mt-1" title="Mandatory">
                                        <input class="form-check-input" type="radio" name="modules[<?php echo e($index); ?>][is_mandatory]" id="mand_<?php echo e($index); ?>" value="1" <?php echo e($module->is_mandatory ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="mand_<?php echo e($index); ?>">M</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-1" title="Optional">
                                        <input class="form-check-input" type="radio" name="modules[<?php echo e($index); ?>][is_mandatory]" id="opt_<?php echo e($index); ?>" value="0" <?php echo e(!$module->is_mandatory ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="opt_<?php echo e($index); ?>">O</label>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label mb-0">Priority</label>
                                    <input type="number" name="modules[<?php echo e($index); ?>][priority]" class="form-control form-control-sm" placeholder="Priority" value="<?php echo e($module->priority); ?>">
                                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="category" class="form-select">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($cat); ?>" <?php echo e(old('category', $course->category) == $cat ? 'selected' : ''); ?>>
                ...
                <div class="col-md-4">
                    ...
                    <select name="level" class="form-select">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lvl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($lvl); ?>" <?php echo e(old('level', $course->level) == $lvl ? 'selected' : ''); ?>>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="subject_area" class="form-control" 
                           value="<?php echo e(old('subject_area', $course->subject_area)); ?>" placeholder="e.g., Business, IT">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="duration" class="form-control" 
                           value="<?php echo e(old('duration', $course->duration)); ?>" placeholder="e.g., 1 year, 6 months">
                </div>

                <div class="col-md-4">
                    <label class="form-label">Duration (Months)</label>
                    <input type="number" name="duration_months" class="form-control" 
                           value="<?php echo e(old('duration_months', $course->duration_months)); ?>" min="1">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="study_method" class="form-select">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $studyMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($method); ?>" <?php echo e(old('study_method', $course->study_method) == $method ? 'selected' : ''); ?>>
                                <?php echo e($method); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-4">
                    ...
                    <select name="currency" class="form-select" required>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($cur); ?>" <?php echo e(old('currency', $course->currency) == $cur ? 'selected' : ''); ?>>
                                <?php echo e($cur); ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="application_fee" 
                           class="form-control" value="<?php echo e(old('application_fee', $course->application_fee)); ?>">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="intake" class="form-select">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $intakes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intake): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($intake); ?>" <?php echo e(old('intake', $course->intake) == $intake ? 'selected' : ''); ?>>
                                <?php echo e($intake); ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="application_deadline" class="form-control" 
                           value="<?php echo e(old('application_deadline', $course->application_deadline ? (is_string($course->application_deadline) ? date('Y-m-d', strtotime($course->application_deadline)) : $course->application_deadline->format('Y-m-d')) : '')); ?>">
                </div>

                <div class="col-md-4">
                    <label class="form-label">Course Start Date</label>
                    <input type="date" name="start_date" class="form-control" 
                           value="<?php echo e(old('start_date', $course->start_date ? (is_string($course->start_date) ? date('Y-m-d', strtotime($course->start_date)) : $course->start_date->format('Y-m-d')) : '')); ?>">
                </div>

                <div class="col-md-4">
                    <label class="form-label">Course End Date</label>
                    <input type="date" name="end_date" class="form-control" 
                           value="<?php echo e(old('end_date', $course->end_date ? (is_string($course->end_date) ? date('Y-m-d', strtotime($course->end_date)) : $course->end_date->format('Y-m-d')) : '')); ?>">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="english_test" class="form-select">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $englishTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($test); ?>" <?php echo e(old('english_test', $course->english_test) == $test ? 'selected' : ''); ?>>
                                <?php echo e($test); ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="english_test_score" class="form-control" 
                           value="<?php echo e(old('english_test_score', $course->english_test_score)); ?>" placeholder="e.g., 6.5 or 100">
                </div>

                <div class="col-12">
                    <label class="form-label">Entry Requirements</label>
                    <textarea name="entry_requirements" class="form-control" rows="2"><?php echo e(old('entry_requirements', $course->entry_requirements)); ?></textarea>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->thumbnail): ?>
                        <div class="mt-2">
                            <img src="<?php echo e(Storage::url($course->thumbnail)); ?>" alt="Thumbnail" class="img-thumbnail" style="max-height: 100px;">
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <div id="course_brochures_container">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->brochures->count() > 0): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $course->brochures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $brochure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="row g-2 mb-2 align-items-center brochure-row mt-2">
                                    <input type="hidden" name="brochures[<?php echo e($index); ?>][id]" value="<?php echo e($brochure->id); ?>">
                                    <div class="col-md-4">
                                        <label class="form-label mb-0">Brochure Title</label>
                                        <input type="text" name="brochures[<?php echo e($index); ?>][title]" class="form-control form-control-sm" placeholder="e.g. Course Syllabus" value="<?php echo e($brochure->title); ?>">
                                    </div>
                                    <div class="col-md-5">
                                        <label class="form-label mb-0">Upload PDF</label>
                                        <input type="file" name="brochures[<?php echo e($index); ?>][file]" class="form-control form-control-sm" accept=".pdf,.doc,.docx">
                                        <small class="text-muted mt-1 d-block">Current: <a href="<?php echo e(Storage::url($brochure->file_path)); ?>" target="_blank">View File</a></small>
                                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="sort_order" class="form-control" 
                           value="<?php echo e(old('sort_order', $course->sort_order)); ?>">
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-check form-switch mt-4">
                        <input type="checkbox" name="is_available_for_admission" value="1" 
                               ...
                               <?php echo e(old('is_available_for_admission', $course->is_available_for_admission) ? 'checked' : ''); ?>>
...
$(document).ready(function() {
    ...
    const oldInstitute = "<?php echo e(old('partner_institute', $course->partner_institute)); ?>";
    ...
    // Module dynamic rows
    let moduleIndex = <?php echo e(isset($course) && $course->modules ? max(1, $course->modules->count()) : 1); ?>;
    ...
    let brochureIndex = <?php echo e($course->brochures->count() > 0 ? $course->brochures->count() : 1); ?>;
...
<?php echo $__env->make('layouts.backend_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iLap\resources\views\backend\courses\edit.blade.php ENDPATH**/ ?>