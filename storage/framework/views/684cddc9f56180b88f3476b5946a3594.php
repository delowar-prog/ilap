...
<style>
    ...
    .bg-light-purple { background: rgba(142, 68, 173, 0.1); color: #8e44ad; }
    ...
    <div class="col-12">
        <div class="dashboard-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <h2 class="text-white mb-2 fw-bold">Welcome back, <?php echo e(ucwords(trim($student->first_name . ' ' . $student->middle_name . ' ' . $student->surname))); ?>! 👋</h2>
