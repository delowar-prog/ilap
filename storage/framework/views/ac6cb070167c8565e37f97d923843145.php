...
<head>
    ...
    <title><?php echo e($title ?? 'Document Letter'); ?></title>
    <style>
        @page {
            ...
            <table style="width: 100%; margin-top: 10px; border-collapse: collapse;">
                <tr>
                    <td style="text-align: left; font-size: 11px; color: #555; line-height: 1.4;">
                        ...
                        <strong>Ref No:</strong> ILAP/LTR/<?php echo e(date('Y')); ?>/<?php echo e(str_pad($student->id ?? rand(100,999), 5, '0', STR_PAD_LEFT)); ?>

                    </td>
                    <td style="text-align: right; font-size: 11px; color: #555; vertical-align: bottom;">
                        <strong>Student ID:</strong> <?php echo e($student->student_code ?? ('STU-' . str_pad($student->id ?? 1, 5, '0', STR_PAD_LEFT))); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activeSignatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <td style="width: <?php echo e(100 / count($activeSignatures)); ?>%; text-align: center; vertical-align: top; padding: 0 10px;">
                                <div style="display: inline-block; text-align: center;">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!isset($sig['type']) || $sig['type'] !== 'seal'): ?>
...
<?php /**PATH C:\laragon\www\iLap\resources\views\backend\pdf\letter_layout.blade.php ENDPATH**/ ?>