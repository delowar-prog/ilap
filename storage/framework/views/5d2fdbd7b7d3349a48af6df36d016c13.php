...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('admin.letter-templates.update', $letterTemplate->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title', $letterTemplate->title)); ?>" required>
                        </div>
                        <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>" onchange="toggleCustomType(this.value)" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($types)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeOpt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <option value="<?php echo e($typeOpt); ?>" <?php echo e(old('type', $letterTemplate->type) == $typeOpt ? 'selected' : ''); ?>><?php echo e($typeOpt); ?></option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="subject" class="form-control" value="<?php echo e(old('subject', $letterTemplate->subject)); ?>">
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($letterTemplate->header_image): ?>
                                <div class="mt-2">
                                    <small class="text-success d-block mb-1"><i class="fas fa-check-circle"></i> Current Header Uploaded:</small>
                                    <img src="<?php echo e(asset('storage/' . $letterTemplate->header_image)); ?>" alt="Header" class="img-thumbnail" style="max-height: 50px;">
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div class="col-md-6">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($letterTemplate->footer_image): ?>
                                <div class="mt-2">
                                    <small class="text-success d-block mb-1"><i class="fas fa-check-circle"></i> Current Footer Uploaded:</small>
                                    <img src="<?php echo e(asset('storage/' . $letterTemplate->footer_image)); ?>" alt="Footer" class="img-thumbnail" style="max-height: 50px;">
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>" rows="12" required><?php echo e(old('content_body', $letterTemplate->content_body)); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.backend_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iLap\resources\views\backend\letter_templates\edit.blade.php ENDPATH**/ ?>