                                    ...
                                    <form action="<?php echo e(route('admin.config.dropdown.update', $opt->id)); ?>" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="d-flex flex-column gap-1">
                                            ...
                                            <div class="d-flex gap-2 align-items-center mt-1 flex-wrap bg-light p-1 rounded border">
                                                ...
                                                <input type="number" name="margin_top" value="<?php echo e($opt->margin_top ?? 130); ?>" class="form-control form-control-sm" style="width:70px;" title="Top Margin (Header Height)" placeholder="Top">
                                                <input type="number" name="margin_bottom" value="<?php echo e($opt->margin_bottom ?? 120); ?>" class="form-control form-control-sm" style="width:70px;" title="Bottom Margin (Footer Height)" placeholder="Bot">
                                                <input type="number" name="margin_left" value="<?php echo e($opt->margin_left ?? 0); ?>" class="form-control form-control-sm" style="width:70px;" title="Left Margin" placeholder="Left">
                                                <input type="number" name="margin_right" value="<?php echo e($opt->margin_right ?? 0); ?>" class="form-control form-control-sm" style="width:70px;" title="Right Margin" placeholder="Right">
                                            </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </form>
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.config.dropdown.store', $category)); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category === 'visa_required_countries'): ?>
                            <div class="custom-multi-select-wrap">
                                <select id="visa_country_select" name="label[]" class="form-select select2-multiple <?php $__errorArgs = ['label'];
...
unset($__errorArgs, $__bag); ?>" multiple="multiple" data-placeholder="Select countries..." required>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Country::orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="mb-3 p-3 bg-light rounded border">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                ...
                                <input type="number" name="margin_top" class="form-control form-control-sm" placeholder="Auto / 130" value="<?php echo e(old('margin_top')); ?>">
                            </div>
                            <div class="col-6">
                                <label class="form-label font-12 text-muted mb-1">Bottom Margin (Footer)</label>
                                <input type="number" name="margin_bottom" class="form-control form-control-sm" placeholder="Auto / 120" value="<?php echo e(old('margin_bottom')); ?>">
                            </div>
                            <div class="col-6">
                                <label class="form-label font-12 text-muted mb-1">Left Margin (Side)</label>
                                <input type="number" name="margin_left" class="form-control form-control-sm" placeholder="0" value="<?php echo e(old('margin_left', 0)); ?>">
                            </div>
                            <div class="col-6">
                                <label class="form-label font-12 text-muted mb-1">Right Margin (Side)</label>
                                <input type="number" name="margin_right" class="form-control form-control-sm" placeholder="0" value="<?php echo e(old('margin_right', 0)); ?>">
                            </div>
                        </div>
