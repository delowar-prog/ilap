<?php $__env->startSection('title', 'Direct Chat with Admin'); ?>
            ...
            <div class="col-lg-4 col-md-5 chat-sidebar">
                ...
                <div class="overflow-auto flex-grow-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a href="<?php echo e(route('student.chat.index', ['conversation_id' => $conv->id])); ?>" 
                           class="conversation-item <?php echo e($activeConversation && $activeConversation->id === $conv->id ? 'active' : ''); ?>">
                            <div class="d-flex justify-content-between align-items-start mb-1">
                                <h6 class="mb-0 fw-bold text-dark text-truncate" style="max-width: 180px;">
                                    <?php echo e($conv->subject ?? 'General Conversation'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeConversation): ?>
                    ...
                    <div class="chat-header d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="fw-bold mb-0 text-dark"><?php echo e($activeConversation->subject ?? 'Direct Chat'); ?></h5>
                                <span class="text-muted font-12"><i class="fas fa-circle text-success font-10 me-1"></i> Admin Support Team</span>
                            </div>
                        </div>
                        <div>
                            <span class="badge <?php echo e($activeConversation->status === 'open' ? 'bg-soft-success text-success' : 'bg-soft-secondary text-secondary'); ?> px-3 py-2 rounded-pill font-12">
                                Status: <?php echo e(ucfirst($activeConversation->status)); ?>
                    ...
                    <div class="chat-body" id="chatBody">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <div class="message-wrapper <?php echo e($isMe ? 'me' : 'other'); ?>">
                                <div class="message-bubble">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isMe): ?>
                                        <div class="fw-bold font-12 mb-1 opacity-75"><?php echo e($msg->sender->name ?? 'Admin'); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($msg->attachment): ?>
                                        <div>
                                            <a href="<?php echo e($msg->attachmentUrl); ?>" target="_blank" class="attachment-badge">
                    ...
                    <div class="chat-footer">
                        ...
                        <?php else: ?>
                            <form id="sendMessageForm" action="<?php echo e(route('student.chat.send', $activeConversation->id)); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="newChatModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <form action="<?php echo e(route('student.chat.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function fetchLiveMessages() {
            fetch("<?php echo e(route('student.chat.fetch', $activeConversation->id)); ?>", {
...
<?php echo $__env->make('layouts.backend_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iLap\resources\views/backend/student/chat/index.blade.php ENDPATH**/ ?>