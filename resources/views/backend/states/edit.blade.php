...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit State: {{ $state->name }}</h5>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="state_code" class="form-control @error('state_code') is-invalid @enderror" value="{{ old('state_code', $state->state_code) }}">
