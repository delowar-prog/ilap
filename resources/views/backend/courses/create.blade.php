            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="is_ilap_course" id="is_ilap_course" 
                        ...
                        <option value="1" {{ old('is_ilap_course') == '1' ? 'selected' : '' }}>
                            🏠 iLAP Own Course
                        </option>
                        <option value="0" {{ old('is_ilap_course') == '0' ? 'selected' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="subject_area" class="form-control" 
                           value="{{ old('subject_area') }}" placeholder="e.g., Business, IT">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="duration" class="form-control" 
                           value="{{ old('duration') }}" placeholder="e.g., 1 year, 6 months">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="currency" class="form-select" required>
                        @foreach($currencies as $cur)
                            <option value="{{ $cur }}" {{ old('currency') == $cur ? 'selected' : '' }}>
                                {{ $cur }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="application_fee" 
                           class="form-control" value="{{ old('application_fee') }}">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="intake" class="form-select">
                        ...
                        @foreach($intakes as $intake)
                            <option value="{{ $intake }}" {{ old('intake') == $intake ? 'selected' : '' }}>
                                {{ $intake }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="english_test" class="form-select">
                        ...
                        @foreach($englishTests as $test)
                            <option value="{{ $test }}" {{ old('english_test') == $test ? 'selected' : '' }}>
                                {{ $test }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="english_test_score" class="form-control" 
                           value="{{ old('english_test_score') }}" placeholder="e.g., 6.5 or 100">
                </div>

                <div class="col-12">
                    <label class="form-label">Entry Requirements</label>
                    <textarea name="entry_requirements" class="form-control" rows="2">{{ old('entry_requirements') }}</textarea>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-check form-switch mt-4">
                        <input type="checkbox" name="is_available_for_admission" value="1" 
                               ...
                               {{ old('is_available_for_admission', true) ? 'checked' : '' }}>
...
$(document).ready(function() {
    ...
    const oldInstitute = "{{ old('partner_institute') }}";
