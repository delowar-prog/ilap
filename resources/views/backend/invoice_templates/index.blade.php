...
<div class="card mb-3">
    <div class="card-header py-3 bg-light">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="{{ route('admin.invoice-templates.create') }}" class="btn btn-primary btn-sm rounded-pill px-3">
                ...
                <tbody>
                    @forelse($templates as $index => $template)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="form-check form-switch d-inline-block m-0">
                                    <input class="form-check-input template-status-toggle" 
                                           ...
                                           role="switch" 
                                           data-id="{{ $template->id }}" 
                                           data-url="{{ route('admin.invoice-templates.toggle', $template->id) }}"
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.invoice-templates.preview', $template->id) }}" class="btn btn-sm btn-info text-white me-1" title="Preview Dummy Output">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.invoice-templates.edit', $template->id) }}" class="btn btn-sm btn-primary me-1" title="Edit Template">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.invoice-templates.destroy', $template->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
