    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4 text-center">
                ...
                <div id="current_signature_box" class="mb-3 p-2 border rounded bg-light {{ auth()->user()->signature ? '' : 'd-none' }}">
                    <label class="form-label d-block text-muted small fw-bold mb-1">Current Saved Signature:</label>
                    <img id="current_signature_img" src="{{ auth()->user()->signature ? asset(auth()->user()->signature) : '' }}" class="img-fluid border p-1 rounded bg-white" style="max-height: 80px;" alt="Current Signature">
                </div>
